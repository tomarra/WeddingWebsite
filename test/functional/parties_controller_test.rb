...
class PartiesControllerTest < ActionController::TestCase
  ...
  test "should create party" do
    assert_difference('Party.count') do
      post :create, party: { address: @party.address, city: @party.city, name: @party.name, state: @party.state, zip_code: @party.zip_code }
    end
  ...
  test "should update party" do
    put :update, id: @party, party: { address: @party.address, city: @party.city, name: @party.name, state: @party.state, zip_code: @party.zip_code }
    assert_redirected_to party_path(assigns(:party))
  end
